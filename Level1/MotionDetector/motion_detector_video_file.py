...
config_path = my_path.parent / 'motion detector recording.mov'
video = cv2.VideoCapture('motion detector recording.mov')
...
while(video.isOpened()):
    ...
    status_list = status_list[-2 : ]  #we only need to retain the last two items in the list
