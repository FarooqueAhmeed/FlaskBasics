...
class github_mate:
    ...
    def __init__(self, master):
        ...
        self.get_btn = Button(text="Get", font="times 22 bold", fg="blue", bd=2, relief="raised",
                              command=self.btn_clicked).grid(row=15, column=0)

        self.clear_btn = Button(text="Clear", font="times 22 bold", fg="red", bd=2, relief="raised",
                                command=self.clear_clicked).grid(row=15, column=1)
